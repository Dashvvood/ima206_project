...
class LogConfusionMatrix(Callback):
    ...
    def on_validation_epoch_end(self, trainer: L.Trainer, pl_module: L.LightningModule) -> None:
        ...
        # cm = ConfusionMatrix(
        #     task="multiclass", num_classes=pl_module.num_classes, normalize="none"
        # )(pred_id, y_id).numpy()
        
        # fig = ConfusionMatrixDisplay(cm).plot(cmap="Blues").figure_
        # img = figure2pil(fig)
        # wi = wandb.Image(img, "test")
        # trainer.logger.experiment.log("wi", wi)
